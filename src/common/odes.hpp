...
public:
  ...
  LinearFirstOrderODE(mfem::HypreParMatrix & M, mfem::HypreParMatrix & K, mfem::Vector & f, serac::BoundaryConditionManager & bcs, serac::EquationSolver & invH, serac::EquationSolver & invT) :
    M_(M), K_(K), f_(f), bcs_(bcs), invH_(invH), invT_(invT), previous_dt(-1.0), epsilon(1.0e-8) {
