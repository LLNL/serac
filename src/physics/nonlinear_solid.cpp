...
void NonlinearSolid::setDisplacementBCs(const std::set<int>& disp_bdr, mfem::VectorCoefficient& disp_bdr_coef)
{
...
void NonlinearSolid::setViscosity(mfem::Coefficient& visc_coef) { viscosity_ = &visc_coef; }
