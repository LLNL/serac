                                                      ...
                                                      mfem::ParFiniteElementSpace&  pfes)
{
  ...
  if (auto iter_params = std::get_if<IterativeSolverParameters>(init_params) && iter_params->prec) {
    if (auto amg_prec = std::get_if<HypreBoomerAMGPrec>(&iter_params->prec.value())) {
