...
void ThermalSolver::setTemperatureBCs(const std::set<int>& temp_bdr, mfem::Coefficient& temp_bdr_coef)
{
  bcs_.addEssential(temp_bdr, temp_bdr_coef, *temperature_);
}

void ThermalSolver::setFluxBCs(const std::set<int>& flux_bdr, mfem::Coefficient& flux_bdr_coef)
{
