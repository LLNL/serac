                                                                   ...
                                                                   size_t             parameter_index)
{
  ...
  parameters_[parameter_index].old_state  = std::make_unique<serac::FiniteElementState>(*new_state);
  *parameters_[parameter_index].old_state = 0.0;
...
void BasePhysics::setParameter(size_t parameter_index, FiniteElementState& parameter_state)
{
  ...
  parameters_[parameter_index].old_state  = std::make_unique<serac::FiniteElementState>(parameter_state);
  *parameters_[parameter_index].old_state = 0.0;
  parameters_[parameter_index].sensitivity =
