...
public:
   ...
   */
  ThermalSolidFunctional(const typename ThermalConductionFunctional<order, dim>::SolverOptions& thermal_options,
                         const typename SolidFunctional<order, dim>::SolverOptions& solid_options,
