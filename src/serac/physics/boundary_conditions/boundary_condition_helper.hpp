...
/** 
 * @brief Get a list of essential true dofs, @p ess_tdof_list , corresponding to the element attributes marked in the array @p elem_attr_is_ess
 * 
 * @param[in] fespace   The parallel finite element space 
 * @param[in] elem_attr_is_ess An mfem::Array which indicates whether each element attribute is essential (the length must equal the number of attributes defined on the mesh)
 * @param[out] ess_tdof_list An mfem::Array containing all the true dofs
 * @param[in] component An optional argument denoting which component (of a vector space) is essential, -1 implies all components
 * 
**/
...
/** 
 * @brief A method to mark degrees of freedom associated with elements with the attributes specified in @p element_attr_is_ess
 * 
 * @param[in] fespace   The parallel finite element space 
 * @param[in] elem_attr_is_ess An mfem::Array which indicates whether each element attribute is essential (the length must equal the number of attributes defined on the mesh)
