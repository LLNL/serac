...
void ThermalConduction::setAdjointEssentialBCs(mfem::Coefficient& adj_ess_bdr_coef)
{
  adjoint_.gridFunc().ProjectCoefficient(adj_ess_bdr_coef);
  adjoint_.initializeTrueVec();
}
