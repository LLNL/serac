...
inline void calculate_boundary_integration_points(const mfem::Vector & x_e, 
                                                  Array2D<tensor<dim+1>> & x_q, 
  ...
  auto X_E = detail::Reshape<trial>(x_e.Read(), dim, ndof, num_elements);
