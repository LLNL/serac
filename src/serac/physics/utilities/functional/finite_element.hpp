 ...
 * HCURL denotes a vector-valued function space where only the tangential component is continuous across element boundaries
 * HDIV  denotes a vector-valued function space where only the normal component is continuous across element boundaries
 * L2    denotes a function space where values are discontinuous across element boundaries
 */
enum class Family
{
  QOI,
