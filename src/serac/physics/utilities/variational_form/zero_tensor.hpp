...
constexpr auto operator+(zero_tensor<n ...>, tensor< T, n ... > other) { return other; }

template < typename T, int ... n >
constexpr auto operator+(T other, zero_tensor<n...>) { return other; }
...
template < typename T, int ... n >
constexpr auto operator-(tensor<T, n...> other, zero_tensor<n...>) { return other; }
...
constexpr auto operator*(zero_tensor<n...>, T /*other*/) { return zero_tensor<n...>{}; }

template < typename T, int ... n, typename = std::enable_if_t<std::is_arithmetic_v<T> || is_dual_number<T>::value> >
constexpr auto operator*(T /*other*/, zero_tensor<n...>) { return zero_tensor<n...>{}; }