...
auto remove_first(Dimensions<m, n...>)
{
  return Dimensions<n...>{};
}
...
template <int... m, int... n>
auto concatenate(Dimensions<m...>, Dimensions<n...>)
{
  return Dimensions<m..., n...>{};
};

template <int... m, int... n>
auto operator+(Dimensions<m...>, Dimensions<n...>)
{
  return Dimensions<m..., n...>{};
};

template <int m, int... n>
constexpr auto first(Dimensions<m, n...>)
{
  return m;
}
...
template <int... n>
constexpr auto last(Dimensions<n...> A)
{
  return A[sizeof...(n) - 1];
}
