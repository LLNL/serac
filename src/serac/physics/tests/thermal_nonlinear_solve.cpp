...
void functional_thermal_test_nonlinear_radiation()
{
  ...
  heat_transfer::LinearIsotropicConductor mat{
      1.0,   // mass density
      10.0,  // Specific heat capacity
      26.33  // isotropic thermal conductivity
  };
  ...
  thermal_solver.addCustomBoundaryIntegral(serac::DependsOn<>{}, [&](auto, auto, auto temperature, auto) {
    static constexpr double radiateConstant = 5.67032e-7;  // mW/mm^2 K
    static constexpr double T0              = 25.0;
    using std::pow;
