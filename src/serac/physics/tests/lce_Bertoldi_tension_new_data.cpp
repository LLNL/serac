...
#ifdef FULL_DOMAIN
  ::mfem::Mesh cuboid =
      mfem::Mesh(mfem::Mesh::MakeCartesian3D(12 * nElem, 22 * nElem, nElem, mfem::Element::HEXAHEDRON, lx, ly, lz));
...
#ifdef NEMATIC_STATE
  // ::mfem::Mesh cuboid = mfem::Mesh(mfem::Mesh::MakeCartesian3D(8*nElem, 70*nElem, nElem, mfem::Element::HEXAHEDRON,
  // lx, ly, lz));
  // ::mfem::Mesh cuboid = mfem::Mesh(mfem::Mesh::MakeCartesian3D(10*nElem, 70*nElem, nElem, mfem::Element::HEXAHEDRON,
  // lx, ly, lz));
  // ::mfem::Mesh cuboid = mfem::Mesh(mfem::Mesh::MakeCartesian3D(5*nElem, 50*nElem, nElem, mfem::Element::HEXAHEDRON,
  // lx, ly, lz));
  ::mfem::Mesh cuboid =
      mfem::Mesh(mfem::Mesh::MakeCartesian3D(4 * nElem, 20 * nElem, nElem, mfem::Element::HEXAHEDRON, lx, ly, lz));
#else
  ::mfem::Mesh cuboid =
      mfem::Mesh(mfem::Mesh::MakeCartesian3D(4 * nElem, 20 * nElem, nElem, mfem::Element::HEXAHEDRON, lx, ly, lz));
#endif
