...
int main(int argc, char* argv[])
{
  ...
  SolidMechanics<p, dim, Parameters<H1<p>, L2<p> > > solid_solver(default_static_options, GeometricNonlinearities::On,
                                                                  "lce_solid_functional");
  // SolidMechanics<p, dim, Parameters< H1<p>, L2<p> > > solid_solver(default_static_options,
  // GeometricNonlinearities::Off, FinalMeshOption::Reference,
  //                                      "solid_functional", {temperature, gamma});
  // SolidMechanics<p, dim, Parameters< H1<p>, L2<p> > > solid_solver(default_static_options,
  // GeometricNonlinearities::On, FinalMeshOption::Reference,
  //                                      "solid_functional", {temperature, gamma});
