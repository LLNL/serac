...
TEST(solid_solver, adjoint)
{
  ...
  FiniteElementDual assembled_adjoint_load(StateManager::mesh(), solid_solver.displacement(), "adjoint_load");
  ...
  FiniteElementDual adjoint_essential(StateManager::mesh(), solid_solver.displacement(), "adjoint_essential");
