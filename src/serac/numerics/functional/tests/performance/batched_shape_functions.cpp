...
void cpu_batched_kernel_simd(const tensor<tensor<simd_type, 1>, n, n, n>* u,
                             tensor<tensor<simd_type, 1>, n, n, n>* r, const size_t num_element_blocks,
                             tensor<simd_type, q, q, q>* D1, tensor<tensor<simd_type, 3, 3>, q, q, q>* D2)
{
