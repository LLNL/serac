...
constexpr auto make_dual(const serac::tuple< T00, T01 > & arg0) {
  return serac::tuple {
    make_dual_helper< 0, 2 >(serac::get<0>(arg0)),
    make_dual_helper< 1, 2 >(serac::get<1>(arg0))
  };
}

template < typename T00, typename T01, typename T10, typename T11 >
constexpr auto make_dual(const serac::tuple< T00, T01 > & arg0,
                         const serac::tuple< T10, T11 > & arg1) {
  return serac::tuple {
    serac::tuple{make_dual_helper< 0, 4 >(serac::get<0>(arg0)),
                 make_dual_helper< 1, 4 >(serac::get<1>(arg0))},
    serac::tuple{make_dual_helper< 2, 4 >(serac::get<0>(arg1)),
                 make_dual_helper< 3, 4 >(serac::get<1>(arg1))}
  };
}
...
constexpr auto make_dual(const serac::tuple< T00, T01 > & arg0,
  ...
  return serac::tuple {
    serac::tuple{make_dual_helper< 0, 6 >(serac::get<0>(arg0)),
                 make_dual_helper< 1, 6 >(serac::get<1>(arg0))},
    serac::tuple{make_dual_helper< 2, 6 >(serac::get<0>(arg1)),
                 make_dual_helper< 3, 6 >(serac::get<1>(arg1))},
    serac::tuple{make_dual_helper< 4, 6 >(serac::get<0>(arg2)),
                 make_dual_helper< 5, 6 >(serac::get<1>(arg2))}
  };
}
