...
struct IdentityFunctor {
  ...
  SERAC_HOST_DEVICE auto operator()(Arg1, Arg2) const { return 1.0; }
};
...
TEST(BoundaryIntegralQOI, AttrBug)
{
  ...
  totalSurfArea.AddBoundaryIntegral(
      serac::Dimension<2 - 1>{}, serac::DependsOn<>{}, IdentityFunctor{}, *pmesh);
  ...
  attr1SurfArea.AddBoundaryIntegral(
      serac::Dimension<2 - 1>{}, serac::DependsOn<>{}, IdentityFunctor{}, attr1);
