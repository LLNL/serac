...
struct nth_type_base<std::integer_sequence<int, j...>, i, T...> : public std::conditional<i == j, T, nothing>::type... {
};
...
template <int... i, typename... T>
struct typelist_base<std::integer_sequence<int, i...>, T...> : public type_at_position<i, T>... {
