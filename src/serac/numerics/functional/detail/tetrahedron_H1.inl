...
struct finite_element<mfem::Geometry::TETRAHEDRON, H1<p, c> > : public impl::TetH1< Family::H1, p, c >{};

template <int p, int c>
struct finite_element<mfem::Geometry::TETRAHEDRON, H1Bar<p, c> > : public impl::TetH1< Family::H1BAR, p, c >{};
/// @endcond
