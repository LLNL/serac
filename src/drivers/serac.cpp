...
int main(int argc, char *argv[])
{
   ...
   mfem::VectorCoefficient *defo_coef = new mfem::VectorFunctionCoefficient(dim,
                                                                            InitialDeformation);
