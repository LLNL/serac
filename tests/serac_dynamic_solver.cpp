...
TEST(dynamic_solver, dyn_solve)
{
  ...
  double v_norm = dyn_solver.getVelocity()->getGridFunc()->ComputeLpError(2.0, zerovec);
  double x_norm = dyn_solver.getDisplacement()->getGridFunc()->ComputeLpError(2.0, zerovec);
