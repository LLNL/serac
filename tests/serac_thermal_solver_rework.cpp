...
TEST(thermal_solver_rework, static_solve)
{
...
TEST(thermal_solver_rework, static_solve_multiple_bcs)
{
  MPI_Barrier(MPI_COMM_WORLD);
...
TEST(thermal_solver_rework, static_solve_repeated_bcs)
{
  MPI_Barrier(MPI_COMM_WORLD);
...
TEST(thermal_solver_rework, dyn_exp_solve)
{
  MPI_Barrier(MPI_COMM_WORLD);
...
TEST(thermal_solver_rework, dyn_imp_solve)
{
  MPI_Barrier(MPI_COMM_WORLD);
