...
class Serac(CachedCMakePackage, CudaPackage):
    ...
    debug_deps = ["mfem-cmake@4.2.0{0}".format(mfem_variants),
    ...
    def initconfig_package_entries(self):
        ...
        dep_dir = get_spec_path(spec, "mfem-cmake", path_replacements)
        entries.append(cmake_cache_path("MFEM_DIR", dep_dir))
